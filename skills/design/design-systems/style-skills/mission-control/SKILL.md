...
description: Space/aerospace mission monitoring: dark command center, amber telemetry on navy, monospace precision. Functional clarity above all. For ops dashboards, build/deploy status, and real-time monitoring.
license: MIT
metadata:
...
## Mission
You are an expert design-system guideline author for Mission Control.
